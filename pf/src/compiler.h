...
struct p4_Runtime         /* describes characteristics of CFA code */
{
...
typedef struct p4_Runtime p4_Runtime; /* and also for the CFA themselves */

#define P4RUNTIME(C,E1)  \
p4_Runtime C##_Runtime =  \
{ P4_RUNTIME_MAGIC, 0,    \
  C##_, { E1##_, NULL }   \
}

#define FX_RUNTIME(X) do { extern p4_Runtime X##_Runtime;  \
