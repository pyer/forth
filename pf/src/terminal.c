...
P4_LISTWORDS (terminal) =
{
    ...
    P4_CONSTANT ("K-LEFT",       K_LEFT),
    P4_CONSTANT ("K-RIGHT",      K_RIGHT),
    P4_CONSTANT ("K-UP",         K_UP),
    P4_CONSTANT ("K-DOWN",       K_DOWN),
    P4_CONSTANT ("K-HOME",       K_HOME),
    P4_CONSTANT ("K-END",        K_END),
    P4_CONSTANT ("K-PRIOR",      K_PRIOR),
    P4_CONSTANT ("K-NEXT",       K_NEXT),
    P4_CONSTANT ("K-INSERT",     K_INSERT),
    P4_CONSTANT ("K-DELETE",     K_DELETE),
/*
    P4_CONSTANT ("K-F1",            K_k1),
    P4_CONSTANT ("K-F2",            K_k2),
    P4_CONSTANT ("K-F3",            K_k3),
    P4_CONSTANT ("K-F4",            K_k4),
    P4_CONSTANT ("K-F5",            K_k5),
    P4_CONSTANT ("K-F6",            K_k6),
    P4_CONSTANT ("K-F7",            K_k7),
    P4_CONSTANT ("K-F8",            K_k8),
    P4_CONSTANT ("K-F9",            K_k9),
    P4_CONSTANT ("K-F10",           K_k0),
    P4_CONSTANT ("K-F11",        K_F1),
    P4_CONSTANT ("K-F12",        K_F2),
*/
    P4_FXco ("KEY",          pf_key),
